...
export default function Navbar() {
  return (
    <nav
      className={clsx("sticky top-0 z-50 w-full px-8 md:px-18 py-6 flex justify-between items-center transition-all duration-300", "bg-white backdrop-blur-3xl dark:bg-transparent shadow-sm dark:shadow-white/5 border-b border-zinc-100/10")}
    >
