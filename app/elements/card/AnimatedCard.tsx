    ...
    <div className="e-card playing relative backdrop-blur-3xl w-full h-65 rounded-2xl overflow-hidden shadow-lg dark:shadow-white2-500/10 bg-transparent mx-auto">
      ...
      <div className="relative flex justify-center items-center flex-col right-0 top-9 text-center text-white font-semibold text-lg">
        ...
        <div className="flex justify-center content-center px-1 -ml-[20px] md:-ml-7 w-full items-center gap-2 mt-4 md:mt-2">
          <p className="text-dark2-600/25 inline-block self-center place-content-center dark:text-white2-500/70 text-[calc(.7rem+.6vw)] border-r-2 border-[#d4af37]/50 pr-3 min-h-[55px]">{day}</p>
          <div className="-mt-1">
          ...
          <p className="text-dark2-600/25 dark:text-white2-500/70 place-content-center text-[calc(.7rem+.6vw)] border-l-2 border-[#d4af37]/50 pl-3 min-h-[55px]">{year}</p>
        </div>
      </div>
    </div>
  );
