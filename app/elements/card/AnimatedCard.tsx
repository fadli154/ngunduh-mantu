...
export default function AnimatedCard({ title, date, time }: CardProps) {
  return (
    <div className="e-card playing relative backdrop-blur-3xl w-full h-70 rounded-2xl overflow-hidden shadow-lg dark:shadow-white2-500/20 bg-transparent mx-auto mt-5">
      {/* Animated Waves */}
      ...
      {/* Info Section */}
      <div className="relative flex justify-center items-center flex-col right-0 top-20 text-center text-white font-semibold text-lg">
