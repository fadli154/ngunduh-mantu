  ...
  return (
    <div className="e-card playing relative backdrop-blur-3xl w-full h-65 rounded-2xl overflow-hidden shadow-lg dark:shadow-white2-500/10 bg-transparent mx-auto">
      ...
      <div className="relative flex justify-center items-center flex-col right-0 top-9 text-center text-white font-semibold text-lg">
        ...
        <div className="flex items-center content-center align-middle gap-2 justify-center text-dark2-600/50 dark:text-white2-500">
          <FaClock size={12} />
        ...
        <div className="flex justify-center content-center ml-5 md:ml-7 w-full items-center gap-2 mt-2">
          ...
          <div className="-mt-1">
            ...
            <p className="text-dark2-600/25 dark:text-white2-500/70 text-[calc(.7rem+.6vw)] -mt-1 md:-mt-2">{year}</p>
          </div>
          <p className="text-dark2-600/25 dark:text-white2-500/70 place-content-center text-[calc(.7rem+.6vw)] border-l-2 border-[#d4af37]/50 pl-2 min-h-[55px]">{month}</p>
        </div>
      </div>
    </div>
  );
