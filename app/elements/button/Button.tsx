    ...
    >
      <div className="relative flex items-center justify-center gap-2 overflow-hidden">
        <span className="relative flex items-center justify-center h-5 md:h-6">
          <span className="transition-transform duration-300 group-hover:-translate-y-full">{children}</span>
          <span className="absolute top-full transition-transform duration-300 group-hover:translate-y-[-100%]">Right Now</span>
        </span>
