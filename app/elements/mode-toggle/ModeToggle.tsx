...
export function ModeToggle() {
  ...
  return (
    <DropdownMenu.Root open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content ref={contentRef} align="end" sideOffset={8} className="z-50 mt-2 w-40 rounded-md border bg-popover p-1 text-popover-foreground shadow-md">
