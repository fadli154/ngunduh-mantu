...
export default function WeddingGallery() {
  ...
  return (
    <section
      className="py-18 md:py-20 px-4 sm:px-6 lg:px-10 transition-colors duration-300"
      id="gallery"
    >
