...
export default function GiftSection() {
  return (
    <section
      id="gift"
      className="px-6 py-20 md:py-28 bg-primary-500/10 dark:bg-dark2-600 flex justify-center items-center "
    >
      <div className="w-full max-w-5xl flex flex-col items-center text-center gap-10">
        <div className="flex justify-center items-center flex-col">
          ...
          <p className="text-sm md:text-md mt-1 text-center text-dark2-600/60 dark:text-white2-500/50 max-w-[90%] lg:max-w-[70%] text-[calc(.7rem+.7vw)]">
            ...
            mengirimkan tanda kasih, dapat ketuk kartu ini untuk menyalin nomor
            rekening.
          </p>
        </div>

        <div className="w-full flex flex-col md:flex-row justify-center items-center gap-5 -mt-4">
          <FlipCard bankName="BRI" rek="7369 0101 414 4530" name="Multahara" />
          <FlipCard
            bankName="Mandiri"
            rek="1760 0055 413 52"
            name="Agung Afriansyah"
          />
        </div>
      </div>
    </section>
