...
export default function Home() {
  ...
  const flowers = [
    { id: 1, src: "/img/flower1.png", x: "-left-18 top-70 md:-top-8", translate: "rotate-90" },
    { id: 2, src: "/img/flower1.png", x: "-right-18 top-70 md:-top-8", translate: "-rotate-90" },
    { id: 3, src: "/img/flower1.png", x: "-left-18 bottom-60 md:-bottom-28", translate: "rotate-100" },
    { id: 4, src: "/img/flower1.png", x: "-right-18 bottom-60 md:-bottom-28", translate: "-rotate-100" },
  ];
  ...
  return (
    ...
    >
      ...
      {flowers.map((flower, i) => (
        <motion.div key={flower.id} className={`absolute w-35 h-35 lg:w-60 lg:h-60 2xl:w-60 2xl:h-60 ${flower.x} ${flower.translate}`} initial="hidden" animate={isInView ? "visible" : "hidden"} variants={flowerVariants} custom={i}>
