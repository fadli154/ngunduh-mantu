...
export default function EventInfo() {
  return (
    <section className="w-full relative bg-primary-500/10 dark:bg-dark2-600 text-white dark:text-white2-500 px-6 py-25 transition-colors duration-500 flex flex-col justify-center items-center" id="info">
