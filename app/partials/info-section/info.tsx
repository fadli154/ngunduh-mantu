    ...
    <section className="w-full bg-primary-500/10 dark:bg-dark2-600 text-white dark:text-white2-500 px-6 py-20 transition-colors duration-500 flex flex-col justify-center items-center" id="info">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <motion.p
          ...
          className="text-sm md:text-md 2xl:text-lg mt-5 bg-text-500/5 dark:bg-text-500/15 shadow-lg dark:shadow-primary-500/15 p-6 rounded-md text-pretty text-start text-dark2-600/40 dark:text-white2-500/80"
        >
